...
TEST(Analyser, variableInitialisedUsingAnotherVariable)
{
    ...
    const std::vector<std::string> expectedIssues = {
        "Variable 'xStateStateAlgebraic' in component 'main' is initialised using variable 'kStateStateAlgebraic', which is a linear algebraic variable. Only a reference to a constant, a computed constant, a state variable, or a non-linear algebraic variable is allowed.",
        "Variable 'xNlaStateAlgebraic' in component 'main' is initialised using variable 'kNlaStateAlgebraic', which is a linear algebraic variable. Only a reference to a constant, a computed constant, a state variable, or a non-linear algebraic variable is allowed.",
        "Variable 'xStateNlaAlgebraic' in component 'main' is initialised using variable 'kStateNlaAlgebraic', which is a linear algebraic variable. Only a reference to a constant, a computed constant, a state variable, or a non-linear algebraic variable is allowed.",
        "Variable 'xNlaNlaAlgebraic' in component 'main' is initialised using variable 'kNlaNlaAlgebraic', which is a linear algebraic variable. Only a reference to a constant, a computed constant, a state variable, or a non-linear algebraic variable is allowed.",
        "Variable 'xStateAlgebraic' in component 'main' is initialised using variable 'kStateAlgebraic', which is a linear algebraic variable. Only a reference to a constant, a computed constant, a state variable, or a non-linear algebraic variable is allowed.",
        "Variable 'xNlaAlgebraic' in component 'main' is initialised using variable 'kNlaAlgebraic', which is a linear algebraic variable. Only a reference to a constant, a computed constant, a state variable, or a non-linear algebraic variable is allowed.",
    };
